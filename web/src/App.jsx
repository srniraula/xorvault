      ...
      <nav className="navbar navbar-dark shadow-sm" style={{ background: 'linear-gradient(135deg,#0d1b2a,#1b3a5c)' }}>
        <div className="container">
          ...
          <div className="d-flex align-items-center gap-2 mx-auto">
            <button
              className={`btn btn-sm ${activeTab === 'files' ? 'btn-light' : 'btn-outline-light'}`}
              onClick={() => setActiveTab('files')}>
              <i className="bi bi-folder2 me-1"></i>Files
            </button>
            <button
              className={`btn btn-sm ${activeTab === 'metrics' ? 'btn-light' : 'btn-outline-light'}`}
              onClick={() => setActiveTab('metrics')}>
              <i className="bi bi-graph-up-arrow me-1"></i>Metrics
            </button>
          </div>
